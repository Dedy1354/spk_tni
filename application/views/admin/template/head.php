<head>
	...
	<script type="text/javascript" src="<?php echo base_url(); ?>assets/global/plugins/bootstrap-toastr/toastr.min.js"></script>
	...
	<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/pages/gallery_library.js"></script>
