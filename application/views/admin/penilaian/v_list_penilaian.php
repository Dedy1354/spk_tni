			...
			<?php $no=1;foreach ($data as $data): ?>
				<tr>
					...
					<td class="text-center">
						<a href="<?php echo $url_delete.$data->id_pel; ?>" onclick="return confirm('Apakah kamu yakin ingin menghapus ?');"><button type="button" class="btn btn-danger btn-icon btn-rounded btn-xs" data-popup="tooltip" data-placement="top"><i class="icon-trash"></i></button></a>
						...
						<a href="<?php echo $url_detail.$data->id; ?>"><button type="button" class="btn btn-warning btn-icon btn-rounded btn-xs"><i class="icon-book"></i></button></a>		
					</td>
				</tr>
				<?php endforeach ?>
			</tbody>
