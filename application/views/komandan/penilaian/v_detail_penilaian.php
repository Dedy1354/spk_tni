			...
			<div class="col-md-6">
				<fieldset>
                	<legend class="text-semibold"><i class="icon-reading position-left"></i> KESEHATAN</legend>
						...
						<div class="form-group">
							<label class="col-lg-5 control-label">Gigi :</label>
							<div class="col-lg-7">
								<input type="text" readonly class="form-control" value="<?php echo $kriteria_sub[31];?>">
							</div>
						</div>

						<div class="form-group">
							<label class="col-lg-5 control-label">Tensi :</label>
							<div class="col-lg-7">
								<input type="text" readonly class="form-control" value="<?php echo $kriteria_sub[32];?>">
							</div>
						</div>
						<div class="form-group">
							<label class="col-lg-5 control-label">Nadi :</label>
							<div class="col-lg-7">
								<input type="text" readonly class="form-control" value="<?php echo $kriteria_sub[33];?>">
							</div>
						</div>
						<div class="form-group">
							<label class="col-lg-5 control-label">Lingkar Dada :</label>
							<div class="col-lg-7">
								<input type="text" readonly class="form-control" value="<?php echo $kriteria_sub[34];?>">
							</div>
						</div>
						<div class="form-group">
							<label class="col-lg-5 control-label">Lingkar Perut :</label>
							<div class="col-lg-7">
								<input type="text" readonly class="form-control" value="<?php echo $kriteria_sub[35];?>">
							</div>
						</div>
						<div class="form-group">
							<label class="col-lg-5 control-label">Warna Kulit :</label>
							<div class="col-lg-7">
								<input type="text" readonly class="form-control" value="<?php echo $kriteria_sub[36];?>">
							</div>
						</div>
						<div class="form-group">
							<label class="col-lg-5 control-label">Warna Mata :</label>
							<div class="col-lg-7">
								<input type="text" readonly class="form-control" value="<?php echo $kriteria_sub[37];?>">
							</div>
						</div>
						<div class="form-group">
							<label class="col-lg-5 control-label">Urine :</label>
							<div class="col-lg-7">
								<input type="text" readonly class="form-control" value="<?php echo $kriteria_sub[38];?>">
							</div>
						</div>
						<div class="form-group">
							<label class="col-lg-5 control-label">Faeces :</label>
							<div class="col-lg-7">
								<input type="text" readonly class="form-control" value="<?php echo $kriteria_sub[39];?>">
							</div>
						</div>
						<div class="form-group">
							<label class="col-lg-5 control-label">Darah :</label>
							<div class="col-lg-7">
								<input type="text" readonly class="form-control" value="<?php echo $kriteria_sub[40];?>">
							</div>
						</div>
						<div class="form-group">
							<label class="col-lg-5 control-label">Serologis :</label>
							<div class="col-lg-7">
								<input type="text" readonly class="form-control" value="<?php echo $kriteria_sub[11];?>">
							</div>
						</div>
